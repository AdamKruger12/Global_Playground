...
$(".card-wrapper").append(
    $("<div/>", { class: "credit-card-outer" }).append(
        $("<div/>", { class: "credit-card-company" }).append(
            $("<img/>", {class:"img-company", src: "/card_icons/card-logo-unknown.svg"})
        ),
        $("<div/>", { class: "credit-card-number credit-card-font" }),
        $("<div/>", { class: "credit-card-date-prefix", html: "Expires End" }),
        $("<div/>", { class: "credit-card-date credit-card-font", html: "01/18" }),
        $("<div/>", { class: "credit-card-person credit-card-font", html: "MR JOHN SMITH" })
    )
);
